import {Turn, TurnSerialized, TurnType} from "./Turn";
import {Board} from "./Board";
import {PieceMinimal, PieceType, Team} from "./Piece";
...
export default class BoardAPI {
        ...
        this._intervalId = setInterval(() => {
            ...
            for (let r = 0; r < 8; r++) {
                if (!col[r] && this._boardRaw[r][BoardDriver.readCol] !== null) { // Lift
                    this._rawChangeQueue.push({
                        x: BoardDriver.readCol,
                        y: r,
                        lift: true,
                        team: this._boardRaw[r][BoardDriver.readCol].team
                    });
    ...
    public static postCancel(): void {
        ...
        this._errorDesc = `Please move the pieces back to their previous positions.`;
